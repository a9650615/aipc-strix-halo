...
Low-level host concerns the installed system depends on: bootstrap, disk/partition layout, and install-time partitioning contracts (e.g. where the `AIPC_LIVE` installer partition is placed, and how it is reclaimed after install).
