...
_EN: Dict[str, str] = {
    ...
    "weekly": "Weekly",
    "session": "Session",
    "weekly_only_note": "No session/daily limit · weekly only",
    "session_only_note": "No weekly limit · session only",
    "percent_left": "{n}% left",
    "percent_used": "{n}% used",
    "empty": "Empty",
    "reset_due": "Reset due",
...
_ZH_TW: Dict[str, str] = {
    ...
    "weekly": "每週",
    "session": "工作階段",
    "weekly_only_note": "無工作階段／每日上限 · 僅顯示每週",
    "session_only_note": "無每週上限 · 僅顯示工作階段",
    "percent_left": "剩餘 {n}%",
    "percent_used": "已用 {n}%",
    "empty": "無資料",
    "reset_due": "已到重置時間",
...
_ZH_CN: Dict[str, str] = {
    **_ZH_TW,
    ...
    "weekly": "每周",
    "session": "会话",
    "weekly_only_note": "无会话/每日上限 · 仅显示每周",
    "session_only_note": "无每周上限 · 仅显示会话",
    "percent_left": "剩余 {n}%",
    "percent_used": "已用 {n}%",
    "empty": "无数据",
    "reset_due": "已到重置时间",
