...
| 2026-06-28 | 副官 | claude-sonnet-4-6 | phase1-drift-fix-2026-06-28 | phase-1-ai-runtime#R5,3.4 | (this commit) | aligned models.yaml ↔ litellm config.yaml model_ids on the specific-tag side; opened task 3.4 for derived-config render; CLAUDE.md §8 documents exit-2 OPTIONAL convention |
