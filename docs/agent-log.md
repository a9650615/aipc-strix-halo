...
| 2026-06-28 | 大哥 | opus-4.7 | claude-md-roles-and-attribution | n/a (process) | 8516a3a | CLAUDE.md §0 Roles + §11 Attribution added; this log seeded with prior runs back-filled |
...
| 2026-06-28 | 副官 | claude-sonnet-4-6 | claude-md-orchestrator-trailer-2026-06-28 | n/a (repo process) | 8516a3a | CLAUDE.md §11: optional Agent-Orchestrator trailer added (template line + explanatory bullet + two examples); dispatched by claude-opus-4-7 |
...
| 2026-06-28 | 副官 | claude-sonnet-4-6 | phase1-modules-cleanup-2026-06-28 | phase-1-ai-runtime#2.1,2.2 | 8516a3a | structural fix for ai-rocm (yum.repos.d/rocm.repo as data, post-install only installs) and ai-xdna (modules-load.d + udev.rules.d as data, packages.txt emptied pending out-of-tree repo); both remain .disabled until AI PC validates |
...
| 2026-06-29 | 副官 | claude-sonnet-4-6 | cloud-llm-runtime-fix-2026-06-29 | cloud-llm-fallback (runtime decrypt + model IDs) | 8516a3a | replaced dead build-time decrypt with systemd oneshot (aipc-decrypt-cloud-keys.service, ConditionPathExists, optional gracefully); updated cloud model IDs to claude-sonnet-4-6 / claude-opus-4-8 in litellm config, models.yaml, design.md; dispatched by claude-opus-4-7 |
