...
| 2026-06-28 | 副官 | claude-sonnet-4-6 | phase1-modules-cleanup-2026-06-28 | phase-1-ai-runtime#2.1,2.2 | (this commit) | structural fix for ai-rocm (yum.repos.d/rocm.repo as data, post-install only installs) and ai-xdna (modules-load.d + udev.rules.d as data, packages.txt emptied pending out-of-tree repo); both remain .disabled until AI PC validates |
