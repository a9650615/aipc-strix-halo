...
1. `docs/architecture.md` — the long-form source of truth for the project's design (7 phases / 46 modules)
...
**Do not invent new module categories without an OpenSpec change.** The 46 modules in `project.md §7` are exhaustive for v1.
